...
public class MenuItem extends JButton {
    ...
    public MenuItem() {
        ...
        // setIcon(new javax.swing.ImageIcon(getClass().getResource("/home/naotomori/Documents/Java/Application/Dashboard/menu.png")));
        URL url = getClass().getResource("menu.png");
        if(url == null) {
            System.err.println("Rousource not found: /home/naotomori/Documents/Java/Application/Dashboard/menu.png");
        } else {
